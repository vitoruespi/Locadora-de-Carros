...
class EmprestimosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emprestimo" do
    assert_difference("Emprestimo.count") do
      post emprestimos_url, params: { emprestimo: { carro_id: @emprestimo.carro_id, data_fim: @emprestimo.data_fim, data_inicio: @emprestimo.data_inicio, locatario_id: @emprestimo.locatario_id, valor_total: @emprestimo.valor_total } }
    end
  ...
  test "should update emprestimo" do
    patch emprestimo_url(@emprestimo), params: { emprestimo: { carro_id: @emprestimo.carro_id, data_fim: @emprestimo.data_fim, data_inicio: @emprestimo.data_inicio, locatario_id: @emprestimo.locatario_id, valor_total: @emprestimo.valor_total } }
